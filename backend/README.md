...
## Project Structure
    ...
    ├── blank_screen_test_d_35949  # Django project configurations
...
1. Clone this repo and `cd blank_screen_test_d_35949`
...
2. Clone this repo and `cd blank_screen_test_d_35949`
